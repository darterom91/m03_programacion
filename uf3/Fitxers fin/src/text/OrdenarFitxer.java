...
/*
 *  Repàs exemples, primer exemple carreguem dades d'un arxiu en el qual el primer que fem es llegir quants enters hi ha 
 *  a l'arxiu i despres comencem la lectura, carregant dades a l'array, operem i finalment desem les dades a 
 *  l'arxiu finalment.
 * 
 */
...
public class OrdenarFitxer {
	...
	/**
	 * Donat el nom d'un fitxer, llegeix els seus valors i el carrega en un array
	 * d'enters.*
	 * 
	 * @param nom
	 *
	 ...
	 * @param nom
	 *
	 *            Nom de la ruta del fitxer destinació
	 * @param dades
	 *
	 *            Array amb les dades que cal escriure
	 */
